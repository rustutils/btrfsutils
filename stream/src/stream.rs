...
use crate::consts::{
    BTRFS_SEND_A_ATIME, BTRFS_SEND_A_CLONE_CTRANSID, BTRFS_SEND_A_CLONE_LEN,
    BTRFS_SEND_A_CLONE_OFFSET, BTRFS_SEND_A_CLONE_PATH,
    BTRFS_SEND_A_CLONE_UUID, BTRFS_SEND_A_COMPRESSION, BTRFS_SEND_A_CTIME,
    BTRFS_SEND_A_CTRANSID, BTRFS_SEND_A_DATA, BTRFS_SEND_A_ENCRYPTION,
    ...
    BTRFS_SEND_C_CLONE, BTRFS_SEND_C_ENABLE_VERITY, BTRFS_SEND_C_ENCODED_WRITE,
    BTRFS_SEND_C_END, BTRFS_SEND_C_FALLOCATE, BTRFS_SEND_C_FILEATTR,
    BTRFS_SEND_C_LINK, BTRFS_SEND_C_MKDIR, BTRFS_SEND_C_MKFIFO,
    BTRFS_SEND_C_MKFILE, BTRFS_SEND_C_MKNOD, BTRFS_SEND_C_MKSOCK,
    BTRFS_SEND_C_REMOVE_XATTR, BTRFS_SEND_C_RENAME, BTRFS_SEND_C_RMDIR,
    BTRFS_SEND_C_SET_XATTR, BTRFS_SEND_C_SNAPSHOT, BTRFS_SEND_C_SUBVOL,
    BTRFS_SEND_C_SYMLINK, BTRFS_SEND_C_TRUNCATE, BTRFS_SEND_C_UNLINK,
    BTRFS_SEND_C_UPDATE_EXTENT, BTRFS_SEND_C_UTIMES, BTRFS_SEND_C_WRITE,
    CMD_HEADER_LEN, SEND_STREAM_MAGIC, SEND_STREAM_MAGIC_LEN,
    STREAM_HEADER_LEN,
};
use std::io::Read;
use uuid::Uuid;
...
// Maximum number of TLV attribute types we track. (One past the
// largest `BTRFS_SEND_A_*` constant; updates needed if v4 attrs land.)
